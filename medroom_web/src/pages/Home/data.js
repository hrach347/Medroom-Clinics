...
export const dataPoxpatvastum = {
  title: "Մազերի փոխպատվաստում",
  description: "Թափվող և նոսր մազերն արդեն անցյալում են:",
  subtitle:
    "Փոխպատվաստված մազերը կսկսեն աճել 3-րդ ամսվանից, իսկ վերջնական արդյունքը տեսանելի կլինի 1 տարի անց:",
  image: doctorVahe,
